...
@property (nonatomic) COSTouchVisualizerWindow *overlayWindow;
        ...
        for (UITouch *touch in [self.allTouches allObjects]) {
            switch (touch.phase) {
                ...
                case UITouchPhaseMoved: {
                    ...
                    [self bringSubviewToFront:self.overlayWindow];
...
- (COSTouchVisualizerWindow *)overlayWindow {
    if (!_overlayWindow) {
        _overlayWindow = [[COSTouchVisualizerWindow alloc] initWithFrame:self.frame];

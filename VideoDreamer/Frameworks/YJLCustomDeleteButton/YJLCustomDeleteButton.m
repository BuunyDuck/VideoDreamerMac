//
//  YJLCustomDeleteButton.m
//  VideoFrame
//
//  Created by YinjingLi on 10/30/15.
//  Copyright © 2015 Yinjing Li. All rights reserved.
//

#import "YJLCustomDeleteButton.h"

@implementation YJLCustomDeleteButton

- (id)init
{
    CGFloat deleteButtonSize = 0.0f;
    
    if([[UIDevice currentDevice] userInterfaceIdiom] == UIUserInterfaceIdiomPhone)
        deleteButtonSize = 22.0f;
    else
        deleteButtonSize = 32.0f;
...
{
    UIGraphicsBeginImageContextWithOptions(CGSizeMake(32.0f, 32.0f), NO, 0);

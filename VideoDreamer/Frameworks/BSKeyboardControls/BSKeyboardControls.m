...
- (id)initWithFields:(NSArray *)fields
{
    if (self = [super initWithFrame:CGRectMake(0.0f, 0.0f, 320.0f, 44.0f)])
    {
        ...
        [self setSegmentedControl:[[UISegmentedControl alloc] initWithItems:@[ NSLocalizedString(@"Previous", nil),
        ...
        [self setDoneButton:[[UIBarButtonItem alloc] initWithTitle:NSLocalizedString(@"Done", nil)
...
- (void)setFields:(NSArray *)fields
{
    if (fields != _fields)
    {
        ...
        _fields = [[NSArray alloc] initWithArray:fields];
    }
}
